...
def _apply_rangeselector(fig, df):
    ...
    fig.update_xaxes(
        ...
        rangeslider={
            "visible": True,
            "bgcolor": "rgba(26, 16, 8, 0.4)",
            "bordercolor": "rgba(232, 195, 74, 0.15)",
        },
        ...
        if active_tab not in _tab_cache:
            try:
                ...
                _tab_cache[active_tab] = html.Div(
                    [html.H3("Error loading tab"), html.P(str(e))]
                )
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            html.P(
                                [
                                    "Esta herramienta utiliza inteligencia artificial para analizar datos históricos del oro (",
                                    html.Code("GC=F", style={"color": "#D4AF37"}),
                            ...
                            html.P(
                                [
                                    html.Strong(
                                        "¿Para qué sirve? ", style={"color": "#D4AF37"}
                                    ),
                                ...
                                children=[
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            html.Li(
                                                [
                                                    html.Strong("Precio actual"),
                                                    " \u2014 Cotizaci\u00f3n spot del oro (GC=F) en USD/oz. Fuente: Yahoo Finance \u00faltimo cierre.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    ...
                                                    " \u2014 Predicci\u00f3n del ensemble (RF+LR+XGB). ALZA (\u226558% confianza), PRECAUCI\u00d3N (\u226442%), ESTABLE (entre 42-58%).",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong("Certeza"),
                                                    " \u2014 Probabilidad que el modelo asigna a su predicci\u00f3n. Ejemplo: 65% = 6.5/10 de acertar. No es la precisi\u00f3n hist\u00f3rica.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong("Aciertos (Accuracy)"),
                                                    " \u2014 Porcentaje de predicciones correctas en el per\u00edodo de test (20% final de los datos).",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong("Fiabilidad (F1)"),
                                                    " \u2014 Media arm\u00f3nica entre precisi\u00f3n y sensibilidad. Valores >0.5 indican buen equilibrio.",
                                                ]
                                            ),
                                        ],
                                    ),
                                        ...
                                        children=[
                                            html.Li(
                                                [
                                                    ...
                                                    " \u2014 Se correlaciona inversamente con el oro. DXY sube \u2192 oro baja (generalmente).",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    ...
                                                    " \u2014 Mide el miedo del mercado. VIX alto \u2192 incertidumbre \u2192 el oro como refugio puede subir.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong(
                                                        "MA 21 (Media M\u00f3vil 21d)"
                                                    ),
                                                    " \u2014 Tendencia a corto plazo. Precio > MA21 \u2192 tendencia alcista; Precio < MA21 \u2192 tendencia bajista.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong("TNX (Bono USA 10a)"),
                                                    " \u2014 Rendimiento del tesoro. TNX alto \u2192 menor atractivo del oro (que no paga intereses).",
                                                ]
                                            ),
                                        ],
                                    ),
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            html.Li(
                                                [
                                                    html.Strong("Aciertos y Confianza"),
                                                    " \u2014 Barras de retorno diario en verde (aciertos) y rojo (fallos), con l\u00ednea de confianza del modelo.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    ...
                                                    " \u2014 Accuracy, Precisi\u00f3n, Recall, F1 y ROC-AUC en barras con color seg\u00fan valor.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    ...
                                                    " \u2014 Evoluci\u00f3n del acierto del modelo operaci\u00f3n a operaci\u00f3n.",
                                                ]
                                            ),
                                            html.Li(
                                                [
                                                    html.Strong(
                                                        "Rendimiento ML vs B&H"
                                                    ),
                                                    " \u2014 Backtest detallado en la pesta\u00f1a correspondiente.",
                                                ]
                                            ),
                                        ],
                                    ),
                                    ...
                                    html.P(
                                        "1. Revisa la se\u00f1al del d\u00eda y la certeza en las tarjetas superiores.",
                                        style={"margin": "2px 0"},
                                    ),
                                    html.P(
                                        "2. Los gr\u00e1ficos inferiores muestran el rendimiento del modelo, no el precio del oro.",
                                        style={"margin": "2px 0"},
                                    ),
                                    html.P(
                                        "3. Navega por las pesta\u00f1as superiores para ver precio, indicadores t\u00e9cnicos, macro, backtest y simulaci\u00f3n.",
                                        style={"margin": "2px 0"},
                                    ),
                                    html.P(
                                        html.Em(
                                            "Nota: Los datos se actualizan con cada cierre diario. El modelo se re-entrena autom\u00e1ticamente. No es asesor\u00eda financiera."
                                        ),
                                        style={
                                            "marginTop": "8px",
                                            "fontSize": "0.8rem",
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                "Aciertos y Confianza del Modelo",
                                className="card-title",
                            ),
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="summary-deviation",
                                    figure=build_prediction_deviation_figure(),
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                ...
                                children=dcc.Graph(
                                    id="summary-learning",
                                    figure=build_learning_curve_figure(),
                                    config={"displayModeBar": False},
                                ),
                            ),
                        ],
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    build_stat_card(
                                        "Precision",
                                        f'{context["precision"]:.1%}',
                                        "Calidad de aciertos ALZA",
                                        "",
                                    ),
                                    build_stat_card(
                                        "Recall",
                                        f'{context["recall"]:.1%}',
                                        "Captura de ALZAS reales",
                                        "",
                                    ),
                                    build_stat_card(
                                        "F1 Score",
    ...
    return html.Div(
        ...
        children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.P(
                                        "1. Extracci\u00f3n: Datos diarios v\u00eda Yahoo Finance desde 2015 (GC=F, DXY, VIX, TNX)."
                                    ),
                                    html.P(
                                        "2. Preprocesamiento: Limpieza, normalizaci\u00f3n y tratamiento de valores faltantes."
                                    ),
                                    html.P(
                                        "3. Feature Engineering: RSI, MACD, medias m\u00f3viles, volatilidad, retornos macro."
                                    ),
                                    html.P(
                                        "4. Modelado: Ensemble con validaci\u00f3n temporal (80% train / 20% test)."
                                    ),
                                    html.P(
                                        "5. Evaluaci\u00f3n: Precisi\u00f3n, F1-Score, ROC-AUC, backtest vs Buy & Hold."
                                    ),
                                ],
                            ),
                        ],
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.Div(
                                        [
                                            html.Span(
                                                "\U0001f40d", className="stack-icon"
                                            ),
                                            html.Div(
                                                "Python 3.10+", className="stack-name"
                                            ),
                                            html.Div(
                                    ...
                                    html.Div(
                                        [
                                            html.Span(
                                                "\U0001f916", className="stack-icon"
                                            ),
                                    ...
                                    html.Div(
                                        [
                                            html.Span(
                                                "\U0001f4bb", className="stack-icon"
                                            ),
                                            html.Div(
                                                "Frontend", className="stack-name"
                                            ),
                                            html.Div(
                                                "Plotly Dash \u00b7 CSS Grid \u00b7 Plotly.js",
                                                className="stack-detail",
                                            ),
                                        ],
                                        className="stack-cell",
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.P(
                                        html.Strong("lr_strong_reg_binary"),
                                        " \u2014 Logistic Regression (C=0.1), modelo principal con mejor F1 (0.70)",
                                    ),
                                    html.P(
                                        html.Strong("rf_binary"),
                                        " \u2014 Random Forest, 100 \u00e1rboles, max_depth=5",
                                    ),
                                    html.P(
                                        html.Strong("xgb_binary"),
                                        " \u2014 XGBoost, 100 estimadores, max_depth=3",
                                    ),
                                    html.P(
                                        html.Strong("lr_multiclass"),
                                        " \u2014 Logistic Regression multiclase (compra/mant\u00e9n/vende)",
                                    ),
                                ],
                            ),
                        ],
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.P(
                                        html.Strong("ALZA"),
                                        " \u2014 Subida esperada (confianza \u2265 58%)",
                                    ),
                                    html.P(
                                        html.Strong("PRECAUCI\u00d3N"),
                                        " \u2014 Ca\u00edda anticipada (confianza \u2264 42%)",
                                    ),
                                    html.P(
                                        html.Strong("ESTABLE"),
                                        " \u2014 Se\u00f1al no concluyente (42-58%)",
                                    ),
                                ],
                            ),
                        ],
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                "Equipo DataScope Solutions", className="card-title"
                            ),
                            html.Div(
                                className="governance-markdown",
                                children=[
                        ...
                        children=[
                            ...
                            html.Img(
                                ...
                                style={
                                    ...
                                    "height": "120px",
                                    "borderRadius": "8px",
                                    "border": "2px solid rgba(232,195,74,0.3)",
                                },
                                alt="QR GitHub",
                            ),
                            html.P(
                                "github.com/juandelaf1/Golden-Forecast",
                                style={
                                    "color": "var(--muted)",
                                    "fontSize": "0.75rem",
                                    "marginTop": "8px",
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        "Limitaciones y Buenas Pr\u00e1cticas", className="card-title"
                    ),
                    html.Div(
                        className="governance-markdown",
                        children=[
                            html.P(
                                "Datos de cierre diario \u2014 no apto para trading de alta frecuencia."
                            ),
                            html.P(
                                "Se\u00f1ales probabil\u00edsticas \u2014 no certezas absolutas. El modelo asigna una confianza, no una garant\u00eda."
                            ),
                            html.P(
                                "Rendimiento pasado no garantiza resultados futuros."
                            ),
                            html.P(
                                "Modelos re-entrenados autom\u00e1ticamente con cada actualizaci\u00f3n de datos."
                            ),
                            html.P(
                                "Gobernanza Scrum \u2014 ramas feature/, PRs con revisi\u00f3n por pares, main protegido."
                            ),
                        ],
                    ),
                ],
    ...
    return html.Div(
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        "Precio del Oro y Señales del Modelo", className="card-title"
                    ),
                    dcc.Loading(
                        type="dot",
                        children=dcc.Graph(
            ...
            html.Div(
                ...
                children=[
                    html.Details(
                        ...
                        children=[
                            html.Summary(
                                "\u00bfC\u00f3mo interpretar los indicadores macro?",
                                className="help-summary",
                            ),
                            html.Div(
                                className="help-copy",
                                children=[
                                    html.H4(
                                        f'DXY (\u00cdndice del D\u00f3lar) \u2014 Actual: {latest.get("dxy", 0):.2f}',
                                        style={
                                            "color": "#AC7D3D",
                                            "margin": "10px 0 4px",
                                            "fontFamily": "Rye, Smokum, serif",
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            html.Li(
                                                "Mide el valor del d\u00f3lar frente a una cesta de 6 divisas (EUR, JPY, GBP, CAD, SEK, CHF)."
                                            ),
                                            html.Li(
                                                "Relaci\u00f3n inversa con el oro: cuando el d\u00f3lar se fortalece (DXY sube), el oro tiende a bajar porque se encarece en otras divisas."
                                            ),
                                            html.Li(
                                                "Rango t\u00edpico: 90-110. Por encima de 105 se considera d\u00f3lar fuerte; por debajo de 95, d\u00f3lar d\u00e9bil."
                                            ),
                                        ],
                                    ),
                                    html.H4(
                                        f'VIX (\u00cdndice de Volatilidad CBOE) \u2014 Actual: {latest.get("vix", 0):.2f}',
                                        style={
                                            "color": "#7A5C33",
                                            "margin": "10px 0 4px",
                                            "fontFamily": "Rye, Smokum, serif",
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            html.Li(
                                                'Conocido como el "\u00edndice del miedo". Mide la volatilidad esperada del S&P 500 para los pr\u00f3ximos 30 d\u00edas.'
                                            ),
                                            html.Li(
                                                "Relaci\u00f3n directa con el oro: VIX alto \u2192 incertidumbre en los mercados \u2192 inversores buscan refugio en el oro."
                                            ),
                                            html.Li(
                                                "Rango t\u00edpico: 12-20 en mercados estables. >30 indica p\u00e1nico; <12 indica complacencia."
                                            ),
                                        ],
                                    ),
                                    html.H4(
                                        f'TNX (Bono del Tesoro USA a 10 a\u00f1os) \u2014 Actual: {latest.get("tnx", 0):.2f}%',
                                        style={
                                            "color": "#5C4732",
                                            "margin": "10px 0 4px",
                                            "fontFamily": "Rye, Smokum, serif",
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            html.Li(
                                                "Rendimiento del bono del gobierno estadounidense a 10 a\u00f1os. Referencia global de tipos de inter\u00e9s."
                                            ),
                                            html.Li(
                                                "Relaci\u00f3n inversa con el oro: TNX alto \u2192 los bonos pagan m\u00e1s intereses \u2192 el oro (que no paga intereses) pierde atractivo."
                                            ),
                                            html.Li(
                                                "Rango t\u00edpico: 1.5-5.0%. Por encima de 4.5% presiona a la baja el oro; por debajo de 2.5% lo favorece."
                                            ),
                                        ],
                                    ),
                                    html.P(
                                        html.Em(
                                            "Interpretaci\u00f3n combinada: El movimiento del oro rara vez depende de un solo factor. Lo ideal es observar los tres indicadores juntos para detectar se\u00f1ales de consenso o divergencia."
                                        ),
                                        style={
                                            "marginTop": "10px",
                                            "fontSize": "0.8rem",
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                "Estrategia ML vs Buy & Hold", className="card-title"
                            ),
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
            ...
            html.Div(
                ...
                children=[
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.DatePickerSingle(
                                        id="sim-end",
                                        date=context["data"].index[-1].date(),
                                        display_format="YYYY-MM-DD",
                                        className="date-picker",
                                    ),
                                ],
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.Label(
                                        "Capital inicial", className="input-label"
                                    ),
                                    dcc.Input(
                                        id="sim-capital",
                                        type="number",
                    ...
                    dcc.Loading(
                        ...
                        children=dcc.Graph(
                            id="sim-chart",
                            figure=build_simulation_placeholder(),
                            config={"displayModeBar": False},
                        ),
                    ),
                ],
...
def build_stat_card(
    title, value, subtitle, help_text=None, accent="#D4AF37"
) -> html.Div:
    children = [
...
def build_price_figure() -> go.Figure:
    ...
    fig.add_trace(
        go.Scatter(
            ...
            marker={
                "color": [
                    WANTED_COLORS["buy"] if s == 1 else WANTED_COLORS["sell"]
    ...
    fig.update_yaxes(
        **AXIS_THEME, title_text="Precio indexado (base 100)", autorange=True
    )
    return fig
...
def build_rsi_figure() -> go.Figure:
    ...
    fig.add_hline(
        y=70,
        line_dash="dash",
        line_color=WANTED_COLORS["rsi_overbought"],
    ...
    fig.add_hline(
        y=30,
        line_dash="dash",
        line_color=WANTED_COLORS["rsi_oversold"],
...
def build_macro_figure() -> go.Figure:
    ...
    fig = make_subplots(
        ...
        subplot_titles=(
            ...
            "Oro vs VIX",
            "Oro vs TNX",
            "Indicadores normalizados (base 100)",
        ),
    )
    ...
    def scatter_with_trend(x, y, color, row, col, x_label):
        ...
        fig.add_trace(
            go.Scatter(
                ...
                mode="markers",
                name=f"ρ={corr:.2f}",
                marker={"color": color, "size": 4, "opacity": 0.25},
            ),
            row=row,
            col=col,
        )
        if len(xv) > 2:
            ...
            fig.add_trace(
                go.Scatter(
                    x=x_sorted,
                    y=polyval([slope, intercept], x_sorted),
                    mode="lines",
                    name="Tendencia",
    ...
    scatter_with_trend(
        df["dxy"], df["gold"], WANTED_COLORS["macro_dxy"], 1, 1, "DXY (Dólar)"
    )
    scatter_with_trend(
        df["vix"], df["gold"], WANTED_COLORS["macro_vix"], 1, 2, "VIX (Volatilidad)"
    )
    scatter_with_trend(
        df["tnx"], df["gold"], WANTED_COLORS["macro_tnx"], 2, 1, "TNX (%)"
    )

    fig.add_trace(
        go.Scatter(
            x=df.index,
            y=df["gold"] / df["gold"].iloc[0] * 100,
            name="Oro",
    ...
    fig.add_trace(
        go.Scatter(
            x=df.index,
            y=df["dxy"] / df["dxy"].iloc[0] * 100,
            name="DXY",
            line={"color": WANTED_COLORS["macro_dxy"], "width": 2},
        ),
        row=2,
        col=2,
    )
    fig.add_trace(
        go.Scatter(
            x=df.index,
            y=df["vix"] / df["vix"].iloc[0] * 100,
            name="VIX",
            line={"color": WANTED_COLORS["macro_vix"], "width": 2},
        ),
        row=2,
        col=2,
    )
    fig.add_trace(
        go.Scatter(
            x=df.index,
            y=df["tnx"] / df["tnx"].iloc[0] * 100,
            name="TNX",
            line={"color": WANTED_COLORS["macro_tnx"], "width": 2},
        ),
        row=2,
        col=2,
    )
...
def build_model_figure() -> go.Figure:
    ...
    fig.update_layout(
        **PLOT_THEME,
        ...
        bargap=0.25,
        title={
            "text": "Rendimiento del Modelo",
            "font": {"family": "Rye, Smokum, serif", "color": WANTED_COLORS["gold"]},
        },
    )
...
def build_backtest_figure() -> go.Figure:
    ...
    if final_alpha < 0:
        fig.add_annotation(
            ...
            showarrow=False,
            font={
                "color": WANTED_COLORS["sell"],
                "size": 11,
                "family": "Space Mono, monospace",
            },
            bgcolor="rgba(255,82,82,0.15)",
            bordercolor=WANTED_COLORS["sell"],
            borderwidth=1,
        )
    fig.update_layout(
        **{**PLOT_THEME, "margin": {"t": 50, "b": 50, "l": 70, "r": 70}},
        ...
        hovermode="x unified",
        title={
            "text": "Backtest: Estrategia ML vs Buy & Hold",
            "font": {"family": "Rye, Smokum, serif", "color": WANTED_COLORS["gold"]},
        },
        yaxis2={
            "overlaying": "y",
    ...
    fig.update_xaxes(**AXIS_THEME, title_text="Fecha")
    fig.update_yaxes(
        **AXIS_THEME, title_text="Rendimiento acumulado (%)", autorange=True
    )
    return fig
...
def build_prediction_deviation_figure() -> go.Figure:
    ...
    idx = test.index[-n:]
    actuals = (
        test["target_binary"].values[-n:]
        if "target_binary" in test.columns
        else (returns > 0).astype(int)
    )
...
def build_learning_curve_figure() -> go.Figure:
    ...
    fig.update_layout(
        **PLOT_THEME,
        ...
        hovermode="x unified",
        title={
            "text": "Precisión del Modelo en el Tiempo",
            "font": {"family": "Rye, Smokum, serif", "color": WANTED_COLORS["gold"]},
        },
...
def build_feature_importance_figure(category="all") -> go.Figure:
    ...
    if not hasattr(rf_result["model"], "feature_importances_"):
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="Importancia no disponible para este tipo de modelo",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
    ...
    if category != "all":
        pairs = [
            (label, v, d, c)
            for label, v, d, c in zip(labels, values, descs, cats)
            if c == category
        ]
        if pairs:
    ...
    fig.update_layout(
        **{**PLOT_THEME, "margin": {"t": 30, "b": 30, "l": 180, "r": 60}},
        ...
        title={
            "text": "Factores que M\u00e1s Influyen en la Predicci\u00f3n",
            "font": {"family": "Rye, Smokum, serif", "color": WANTED_COLORS["gold"]},
        },
    )
    fig.update_xaxes(
        **AXIS_THEME,
        tickformat=".0%",
        title_text="Peso relativo en la decisi\u00f3n del modelo",
    )
...
def build_confusion_matrix_figure() -> go.Figure:
    ...
    if not rf_result:
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="No hay datos de matriz de confusi\u00f3n",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
    ...
    y_true = (
        context["test_data"].get("target_binary")
        if hasattr(context["test_data"], "get")
        else None
    )
    if y_true is None:
        fig = go.Figure()
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="Columna target_binary no disponible",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
...
def build_roc_curve_figure() -> go.Figure:
    ...
    if not rf_result:
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="No hay datos de curva ROC",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
    ...
    if len(np.unique(rf_result["probabilities"])) < 2:
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="ROC no disponible (probabilidades constantes)",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
    ...
    if y_true is None:
        ...
        fig.add_annotation(
            ...
            xref="paper",
            yref="paper",
            text="target_binary no disponible para ROC",
            showarrow=False,
            font={"color": "#D4AF37", "size": 14},
        )
        return fig
...
def build_model_comparison_table() -> html.Div:
    ...
    clf_models = {
        n: r for n, r in model_results.items() if r.get("type") == "classification"
    }
        ...
        clf_rows.append(
            html.Tr(
                [
                    ...
                    html.Td(
                        f'{r["cum_strategy"][-1]:+.1%}',
                        style={**TD, "color": profit_color},
                    ),
                ]
            )
        )
...
TD = {
    "borderBottom": "1px solid rgba(44,26,12,0.3)",
    "padding": "6px 8px",
    "color": "#F5EDE0",
    "fontFamily": "Space Mono, monospace",
    "fontSize": "12px",
...
def build_experimental_section() -> html.Div:
    ...
    return html.Div(
        className="wide-card", style={"marginTop": "16px"}, children=children
    )
                        ...
                        [
                            ...
                            dcc.Dropdown(
                                ...
                                options=[
                                    ...
                                    {
                                        "label": "T\u00e9cnicas (RSI, MACD, Medias...)",
                                        "value": "T\u00e9cnico",
                                    },
                                    {
                                        "label": "Macro (DXY, VIX, TNX...)",
                                        "value": "Macro",
                                    },
                                    {
                                        "label": "Precio (Rendimiento Diario)",
                                        "value": "Precio",
                                    },
                                ],
                                value="all",
            ...
            html.Div(
                ...
                children=[
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                "Matriz de Confusi\u00f3n", className="card-title"
                            ),
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="cm-chart",
                                    figure=build_confusion_matrix_figure(),
                                    config={"displayModeBar": False},
                                ),
                            ),
                        ],
...
def build_regression_tab() -> html.Div:
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.Div(
                        value_text,
                        className="metric-value",
                        style={"color": WANTED_COLORS["gold"]},
                    ),
                    html.Div(
                        detail,
                        style={
    ...
    if not cards:
        cards = [
            html.Div(
                "No hay datos disponibles. Ejecuta el pipeline completo para ver el análisis de Valor y Riesgo.",
                style={
                    "color": "#a89070",
                    "fontSize": "0.9rem",
                    "textAlign": "center",
                    ...
                    html.Details(
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    html.H4(
                                        "Modelos de regresi\u00f3n: valoraci\u00f3n de activos y medici\u00f3n de riesgo",
                                        style={
                                            "color": WANTED_COLORS["gold"],
                                            "margin": "10px 0 4px",
                                            "fontFamily": "Rye, Smokum, serif",
                                    ...
                                    html.P(
                                        "El modelo de clasificaci\u00f3n predice la direcci\u00f3n del precio (sube/baja). Este an\u00e1lisis de Valor y Riesgo responde a:"
                                    ),
                                    html.Ul(
                                        children=[
                                            html.Li(
                                                "\u00bfEst\u00e1 el oro en zona de sobrevaloraci\u00f3n o infravaloraci\u00f3n hist\u00f3rica?"
                                            ),
                                            html.Li(
                                                "\u00bfCu\u00e1nto riesgo de ca\u00edda existe en las pr\u00f3ximas semanas?"
                                            ),
                                            html.Li(
                                                "\u00bfCu\u00e1l es el rango de movimiento esperado?"
                                            ),
                                        ]
                                    ),
                                    html.P(
                                        "Juntos ofrecen una visi\u00f3n completa: saber hacia d\u00f3nde va el precio y entender el contexto de valor y riesgo."
                                    ),
                                ],
                            ),
                        ],
