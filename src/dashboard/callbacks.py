    ...
    def render_tab(active_tab):
        if active_tab not in _tab_cache:
            try:
                ...
                _tab_cache[active_tab] = html.Div([html.H3("Error loading tab"), html.P(str(e))])
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.P(
                                        ...
                                        style={"marginTop": "8px", "fontSize": "0.8rem", "color": "#8D6B34"},
                                    ),
                                ],
                            ),
                        ],
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="summary-model", figure=build_model_figure(), config={"displayModeBar": False}
                                ),
                            ),
                        ],
                    ),
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    build_stat_card(
                                        "Precision", f'{context["precision"]:.1%}', "Calidad de aciertos ALZA", ""
                                    ),
                                    build_stat_card(
                                        "Recall", f'{context["recall"]:.1%}', "Captura de ALZAS reales", ""
                                    ),
                                    build_stat_card(
                                        "F1 Score", f'{context["f1"]:.1%}', "Equilibrio precision-recall", ""
                                    ),
                                ],
                            ),
                        ],
                                ...
                                children=[
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                "pandas \u00b7 numpy \u00b7 scikit-learn", className="stack-detail"
                                            ),
                                        ],
                                    ...
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                "Random Forest \u00b7 LR \u00b7 XGBoost", className="stack-detail"
                                            ),
                                        ],
                                        className="stack-cell",
                                    ),
                                    html.Div(
                                        [
                                            ...
                                            html.Div(
                                                "Plotly Dash \u00b7 CSS Grid \u00b7 Plotly.js", className="stack-detail"
                                            ),
                                        ],
                                        className="stack-cell",
                                    ),
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.P(
                                        html.Strong("rf_binary"), " \u2014 Random Forest, 100 \u00e1rboles, max_depth=5"
                                    ),
            ...
            html.Div(
                ...
                children=[
                    ...
                    dcc.Loading(
                        type="dot",
                        children=dcc.Graph(
                            id="price-chart", figure=build_price_figure(), config={"displayModeBar": False}
                        ),
                    ),
                ],
            ),
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="indicators-rsi", figure=build_rsi_figure(), config={"displayModeBar": False}
                                ),
                            ),
                        ],
                    ),
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="indicators-macd", figure=build_macd_figure(), config={"displayModeBar": False}
                                ),
                            ),
                        ],
                    ),
            ...
            html.Div(
                ...
                children=[
                    html.Details(
                        ...
                        children=[
                            html.Summary(
                                "\u00bfC\u00f3mo interpretar los indicadores macro?", className="help-summary"
                            ),
                            html.Div(
                                className="help-copy",
                                children=[
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            ...
                                            html.Li(
                                                f"Rango t\u00edpico: 90-110. Por encima de 105 se considera d\u00f3lar fuerte; por debajo de 95, d\u00f3lar d\u00e9bil."
                                            ),
                                        ],
                                    ),
                                    html.H4(
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            ...
                                            html.Li(
                                                f"Rango t\u00edpico: 12-20 en mercados estables. >30 indica p\u00e1nico; <12 indica complacencia."
                                            ),
                                        ],
                                    ),
                                    html.H4(
                                    ...
                                    html.Ul(
                                        ...
                                        children=[
                                            ...
                                            html.Li(
                                                f"Rango t\u00edpico: 1.5-5.0%. Por encima de 4.5% presiona a la baja el oro; por debajo de 2.5% lo favorece."
                                            ),
                                        ],
                                    ),
                                    html.P(
                                        ...
                                        style={"marginTop": "10px", "fontSize": "0.8rem", "color": "#8D6B34"},
                                    ),
                                ],
                            ),
                        ],
            ...
            html.Div(
                ...
                children=[
                    ...
                    dcc.Loading(
                        type="dot",
                        children=dcc.Graph(
                            id="macro-chart", figure=build_macro_figure(), config={"displayModeBar": False}
                        ),
                    ),
                ],
            ),
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="model-chart", figure=build_model_figure(), config={"displayModeBar": False}
                                ),
                            ),
                        ],
                    ),
                ...
                children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dcc.DatePickerSingle(
                                        id="sim-start",
                                        date=context["data"].index[context["split_index"]].date(),
                            ...
                            html.Button(
                                "EJECUTAR SIMULACIÓN", id="simulate-button", className="control-button", n_clicks=0
                            ),
                        ],
                    ),
                    html.Div(
                        ...
                        children=[
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.Div(
                                        "$0", id="sim-final", className="metric-value", style={"color": "#F2EBE1"}
                                    ),
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.Div(
                                        "0.0%", id="sim-return", className="metric-value", style={"color": "#F2EBE1"}
                                    ),
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.Div(
                                        "0", id="sim-trades", className="metric-value", style={"color": "#F2EBE1"}
                                    ),
                    ...
                    dcc.Loading(
                        type="dot",
                        children=dcc.Graph(
                            id="sim-chart", figure=build_simulation_placeholder(), config={"displayModeBar": False}
                        ),
                    ),
                ],
            ),
...
def build_macro_figure() -> go.Figure:
    ...
    fig = make_subplots(
        rows=2, cols=2, subplot_titles=("Oro vs DXY", "Oro vs VIX", "Oro vs TNX", "Indicadores normalizados (base 100)")
    )
    ...
    def scatter_with_trend(x, y, color, row, col, x_label):
        ...
        fig.add_trace(
            go.Scatter(
                x=xv, y=yv, mode="markers", name=f"ρ={corr:.2f}", marker={"color": color, "size": 4, "opacity": 0.25}
            ),
            row=row,
            col=col,
        )
            ...
            html.Div(
                ...
                children=[
                    ...
                    dcc.Loading(
                        type="dot",
                        children=dcc.Graph(
                            id="fi-chart", figure=build_feature_importance_figure(), config={"displayModeBar": False}
                        ),
                    ),
                    html.Div(
                        id="fi-detail",
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            dcc.Loading(
                                type="dot",
                                children=dcc.Graph(
                                    id="roc-chart", figure=build_roc_curve_figure(), config={"displayModeBar": False}
                                ),
                            ),
                        ],
                    ),
        ...
        cards.append(
            html.Div(
                ...
                children=[
                    html.Div(
                        t["title"],
                        style={"color": WANTED_COLORS["gold"], "fontFamily": "Rye, Smokum, serif", "fontSize": "1rem"},
                    ),
